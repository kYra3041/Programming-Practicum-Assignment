...
int run_main() { 
    // Hardcoded values
    string name = "Filly Bert Gosling"; // Hardcoded name
    long int gross = 100000000; // Hardcoded gross salary
    long int tax = gross * 0.2; // Calculate tax
    long int installment = 25000; // Hardcoded installment
    long int insurance = 100000; // Hardcoded insurance
